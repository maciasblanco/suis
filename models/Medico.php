...
{
    const TIPO_PERSONAL = parent::MEDICO;
    ...
    {
        return $this->hasMany(Epi10::className(), ['id_medico' => 'id']);
    }
    ...
    {
        return (new MedicoQuery(get_called_class()))->where(['tipo_personal' => self::TIPO_PERSONAL]);
    }
}
