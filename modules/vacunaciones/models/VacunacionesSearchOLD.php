...
class VacunacionesSearch extends Vacunaciones
{
    ...
    {
        return [
            [['id', 'id_dato_persona', 'id_vacuna', 'id_dosis', 'id_establecimiento', 'id_tipo_mision', 'n_hijo', 'id_tipo_vacunacion', 'id_condicion_especial', 'id_menor_edad'], 'integer'],
            [['fecha', 'lote_amarilica'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'id_menor_edad' => $this->id_menor_edad,
        ]);
