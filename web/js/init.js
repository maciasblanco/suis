  ...
  return context[func].apply(this, args);
    ...
    $(document).on("click", ".widget-header .widget-popout", function(event){
      ...
      if(widget.hasClass("modal-widget")){
        ...
        $(widget).draggable({ handle: ".widget-header",containment: ".site-index" }).css({"left":widget.position().left-2,"top":widget.position().top-2}).resizable({minHeight: 150,minWidth: 200});
      }
      window.setTimeout(function () {
        $("body").trigger("resize");
      },300);
